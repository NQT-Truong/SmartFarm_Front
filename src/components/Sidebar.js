...
import { Settings, ToggleLeft, Cpu, Eye } from "react-feather";
      ...
      return (
        ...
        >
          <div className="sidebar-content">
            <PerfectScrollbar>
              <a className="sidebar-brand" href="/systems">
                <CustomImg
                  src={ptit}
                  className="avatar img-fluid rounded-circle mr-1"
                  alt="ptit"
                />
                <span className="align-middle ml-2 font-weight-bold">
                  Phạm Xuân Mạnh
                </span>
              </a>
              ...
              <ul className="sidebar-nav">
                <React.Fragment>
                  ...
                  <SidebarItem
                    ...
                    icon={ToggleLeft}
                  />
                  {/* <SidebarItem name="Camera" to="/Camera" icon={Eye} /> */}
                  <SidebarItem name="Thông số trạm" to="/config" icon={Eye} />
                  {isAdmin ? (
                    <SidebarItem
                      name="Quản trị viên"
                      icon={Settings}
