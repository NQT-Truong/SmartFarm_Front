  ...
  render() {
    ...
    return (
      <Container fluid className="table-project mt-4">
        <Card
          id={"table-project-" + this.state.data._id}
        ...
        >
          ...
          >
            <CustomImg
              className="img--user rounded-circle  mr-2"
            ...
            <CardTitle className="align-middle d-inline-block mb-0 font-size-2x font-weight-bold text-color-black mt-0 border-bottom-0 ml-3">
              <div>
                ...
                <h6 className="text-muted table-project__h6 mt-1">
                  Loại máy:
                  {this.state.data.seed_name === "tomato"
                    ? " DL001"
                    : "" || this.state.data.seed_name === "pakchoi"
                    ? " DL002"
                    : "" || this.state.data.seed_name === "brassica"
                    ? " DL003"
                    : "" || this.state.data.seed_name === "cucumber"
                    ? " DL004"
                    : "" || this.state.data.seed_name === "cabbage"
                    ? " DL005"
                    : ""}
                </h6>
                <h6 className="text-muted table-project__h6 mt-1">
                  Mã Trạm: {this.state.data.sub_id}{" "}
                </h6>
                <h6 className="text-muted table-project__h6">
                  Ngày bắt đầu tạo:{" "}
                  {moment(this.state.data.started_plant).format("YYYY-MM-DD")}
                </h6>
                <UncontrolledTooltip
                  placement={"bottom"}
