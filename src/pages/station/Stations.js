  ...
  render() {
    ...
    return isLoaderAPI1 === true &&
      ...
      <React.Fragment>
        ...
        >
          <ModalHeader>Tạo trạm</ModalHeader>
          <ModalBody>
            <FormGroup>
              <Row>
                <Col xs="6" className="pb-0 !important">
                  <Label for="name_of_project">Tên trạm</Label>
                  <Input
                    type="text"
                    name="name"
                    placeholder="_ _ _ "
                  ...
                  <FormFeedback invalid>
                    Tên trạm là một trường bắt buộc!
                  </FormFeedback>
                </Col>
                <Col xs="6" className="pb-0 !important">
                  <Label>Mã trạm</Label>
            ...
            <FormGroup>
              <Row>
                <Col xs="6" className="pb-0 !important">
                  <Label for="latitude">Tọa độ trạm (Latitude)</Label>
                  <Input
                    type="number"
                    name="latitude"
                    placeholder=""
                ...
                <Col xs="6" className="pb-0 !important">
                  <Label for="longitude">Tọa độ trạm (Longitude)</Label>
                  <Input
                    type="number"
                    name="longitude"
                    placeholder=""
        ...
        <Modal size="md" isOpen={this.state.showModal.config_digital}>
          <ModalHeader>Cài đặt thông số của trạm</ModalHeader>
          <ModalBody>
            <Row>
              <Col xs="5">
                <Label>Chọn máy thu phát</Label>
                <Input
                  type="select"
                  width="10px"
                  ...
                  <Tab eventKey="g1" title="Thông tin">
                    ...
                    >
                      <CardBody className="my-0">
                        <Row>
                          <Col xs="4">Hoạt động ổn định :</Col>
                          <Col
                            xs="8"
                        ...
                        {/* <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={
                                this.state.dataConfig.stage_1.min_soil_moisture
                              }
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          ...
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={
                                this.state.dataConfig.stage_1.max_soil_moisture
                              }
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                        ...
                        {/* <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              name="stage_1.min_PH"
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_1.min_PH}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              name="stage_1.max_PH"
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_1.max_PH}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          >
                            <Input
                              ...
                              value={this.state.dataConfig.stage_2.stage_days}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_2.min_temp}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_2.max_temp}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_2.min_hum}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_2.max_hum}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={
                                this.state.dataConfig.stage_2.min_soil_moisture
                              }
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          ...
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={
                                this.state.dataConfig.stage_2.max_soil_moisture
                              }
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_2.min_light}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_2.max_light}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              name="stage_2.min_PH"
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_2.min_PH}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              name="stage_2.max_PH"
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_2.max_PH}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          >
                            <Input
                              ...
                              placeholder="Tổng số ngày"
                              value={this.state.dataConfig.stage_3.stage_days}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_3.min_temp}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_3.max_temp}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_3.min_hum}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_3.max_hum}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={
                                this.state.dataConfig.stage_3.min_soil_moisture
                              }
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          ...
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={
                                this.state.dataConfig.stage_3.max_soil_moisture
                              }
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_3.min_light}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_3.max_light}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                        ...
                        <Row>
                          ...
                          <Col xs="4" className="mt-4 pr-1">
                            <Input
                              ...
                              name="stage_3.min_PH"
                              placeholder="nhỏ nhất"
                              value={this.state.dataConfig.stage_3.min_PH}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
                          <Col xs="4" className="mt-4">
                            <Input
                              ...
                              name="stage_3.max_PH"
                              placeholder="lớn nhất"
                              value={this.state.dataConfig.stage_3.max_PH}
                              onChange={this.handleChange}
                              autoComplete="off"
                            />
                          </Col>
        ...
        <Navbar className="nav__banner" light expand>
          <Collapse navbar className="float-right">
            <Nav className="ml-auto " navbar>
              <Link to="/logout">
                <h3 className="text-danger m-auto">
                  <FontAwesomeIcon icon={faSignOutAlt} width={3} height={2} />{" "}
                  Sign out
                </h3>
              </Link>
            </Nav>
          ...
          <Row>
            ...
            <Col xs="8" md="4">
              {isAdmin ? (
                ...
                >
                  <FontAwesomeIcon icon={faPlus} width={3} height={2} /> Tạo
                  trạm mới
                </Button>
              ) : null}
            </Col>
