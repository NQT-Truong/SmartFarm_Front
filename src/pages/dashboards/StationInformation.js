    ...
    return (
      <React.Fragment>
        <Tabs defaultActiveKey="info">
          <Tab eventKey="info" title="Thông tin trạm">
            <Card
              className="flex-fill w-100"
              style={{ height: 607, width: "100%" }}
            >
              <CardBody className="my-0">
                ...
                <ul className="list-unstyled mb-0">
                  {/* <li className="mb-3 h4">
                    ...
                    Giai đoạn:{" "}
                    <Link to="#">
                      {data.stage.name === "germination stage"
                        ? "Cây con"
                        : "" || data.stage.name === "development stage"
                        ? "Cây trưởng thành"
                        : "" || data.stage.name === "harvest stage"
                        ? "Thu hoạch"
                        : ""}
                    </Link>
                  </li> */}
                  <li className="mb-3 h4">
                    <CustomImg
                      ...
                      className="mr-2"
                    />{" "}
                    Mã trạm: <Link to="#">{data.sub_id}</Link>
                  </li>
                  {/* <li className="mb-3 h4">
                    <CustomImg
                      src={TreeIcon}
                    ...
                    Hạt giống:{" "}
                    <Link to="#">
                      {data.seed_name === "tomato"
                        ? "Cà chua"
                        : "" || data.seed_name === "cucumber"
                        ? "Dưa chuột"
                        : "" || data.seed_name === "pakchoi"
                        ? "Cải chíp"
                        : "" || data.seed_name === "brassica"
                        ? "Cải ngọt"
                        : "" || data.seed_name === "cabbage"
                        ? "Bắp cải"
                        : ""}
                    </Link>
                  </li> */}
          ...
          <Tab eventKey="map" title="Trạng thái trạm">
            <Card
              className="flex-fill w-100"
              style={{ height: 607, width: "100%" }}
            >
              <CardBody className="my-0">
                <ul className="list-unstyled mb-0">
                  <h3 className="text-center h3 text-primary mb-4">
                    {data.stage.name === "germination stage"
                      ? "Gieo hạt"
                      : "" || data.stage.name === "development 1 stage"
                      ? "Ra hoa"
                      : "" || data.stage.name === "development 2 stage"
                      ? "Phát triển"
                      : "" || data.stage.name === "harvest stage"
                      ? "Thu hoạch"
                      : ""}
                  ...
                  <li className="mb-3 h4">
                    <CustomImg
                      ...
                      className="mr-2"
                    />
                    Độ ẩm : <Link to="#">{data.stage.min_soil_moisture}</Link>{" "}
                    {" < % < "}{" "}
                  ...
                  {/* <li className="mb-3 h4">
                    <CustomImg
                      ...
                      className="mr-2"
                    />
                    Độ ẩm không khí: <Link to="#">{data.stage.min_hum}</Link>{" "}
