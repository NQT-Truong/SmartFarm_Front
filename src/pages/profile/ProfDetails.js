...
import { FileText, Phone, User, Mail, Camera, Users } from "react-feather";
...
class ProfDetails extends Component {
  ...
  updateUser(event) {
    ...
    if (
      this.state.changeFullname !== this.state.fullname ||
      this.state.changeBio !== this.state.bio ||
      this.state.changeGender !== this.state.gender ||
      this.state.changePhone_number !== this.state.phone_number ||
      this.state.changeAddress !== this.state.address
    ) {
      ...
      <Card>
            ...
            <ModalBody>
              ...
              <FormGroup>
                <Label for="fullname">
                  <h5>
                    <dt>
                      Họ & tên <span className="text-color-red">*</span>
                    </dt>
                  </h5>
                </Label>
                <Input
                  ...
                  required
                />
                {this.state.changeFullname === "" && (
                  <div isHidden={this.state.changeFullname === ""}>
        ...
        <CardBody>
          ...
          <ul className="list-unstyled mb-0">
            <div>
              <li className="mb-1">
                ...
                {this.props.email !== null ? (
                  ...
                  <i className="Profile__font-size-078rem">Đang cập nhật</i>
                )}
              </li>
            </div>
            ...
            <div>
              <li className="mb-1">
                <User width={14} height={14} className="mr-1" /> Giới tính:{" "}
            ...
            <div>
              <li className="mb-1">
                <Phone width={14} height={14} className="mr-1" /> SĐT:{" "}
                {this.props.phone_number !== null ? (
            ...
            <li className="mb-1">
              <FileText width={14} height={14} className="mr-1" /> Mã Trạm:{" "}
              {this.props.farms.map((farms, index) => {
                return <p className="d-inline">{farms}, </p>;
              })}
            </li>

            <li className="mb-1">
              <Users width={14} height={14} className="mr-1" /> Ngày tạo:{" "}
              {moment(this.props.date_joined).format("DD/MM/YYYY h:mm:ss a")}
            </li>
          </ul>
