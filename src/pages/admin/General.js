...
class General extends React.Component {
  ...
  handleChange(event) {
    let data = Object.assign(
      {},
      this.state.data,
      this.state.data.stage_1,
      this.state.data.stage_2,
      this.state.data.stage_3,
      this.state.data.stage_4
    );
    let obj = event.target.name.split(".")[0];
    let key = event.target.name.split(".")[1];

    if (obj === "stage_1") data.stage_1[key] = event.target.value;
    else if (obj === "stage_2") data.stage_2[key] = event.target.value;
    else if (obj === "stage_3") data.stage_3[key] = event.target.value;
    else if (obj === "stage_4") data.stage_4[key] = event.target.value;
  ...
  render() {
    ...
    console.log(this.state.listSeed);

    return !(this.state.isLoaded1 && this.state.isLoaded2) ? (
          ...
          <Row>
            <Col md="8">
              <Row>
                <Col md="6">
                  <FormGroup>
                    <Label for="inputStationName">Tên trạm</Label>
                    <Input
                      type="text"
                      name="name"
              ...
              <Row>
                <Col xs="6">
                  <FormGroup>
                    <Label for="name_of_address">Tọa độ trạm (latitude)</Label>
                    <Input
                      type="phone_number"
                      name="latitude"
                ...
                <Col xs="6">
                  <FormGroup>
                    <Label for="name_of_address">Tọa độ trạm (longitude)</Label>
                    <Input
                      type="phone_number"
                      name="longitude"
              ...
              <Row>
                <Col xs="6">
                  ...
                  >
                    <option value={this.state.listSeed[0]._id}>DL001</option>
                    <option value={this.state.listSeed[1]._id}>DL002</option>
                    <option value={this.state.listSeed[2]._id}>DL003</option>
                    <option value={this.state.listSeed[3]._id}>DL004</option>
                    <option value={this.state.listSeed[4]._id}>DL005</option>
                  </Input>
                </Col>
                <Col xs="6">
                  <FormGroup>
                    <Label for="name_of_address">Mã Trạm</Label>
                    <Input
                      disabled
                      type="text"
                      name="sub_id"
              ...
              <Row className="mt-5">
                ...
                <Col md="4" className="admin__button-save  text-center">
                  ...
                  <Modal isOpen={this.state.modal} toggle={this.toggle}>
                    ...
                    <ModalBody>Bạn có chắc chắn xóa trạm này không?</ModalBody>
                    <ModalFooter>
                      <Button
                        className="mt-1"
                        color="secondary"
                      ...
                      <Button
                        ...
                        color="success"
                        size="lg"
                        onClick={this.handleDelProject.bind(this)}
                      >
                        Đồng ý
                      </Button>
                    </ModalFooter>
